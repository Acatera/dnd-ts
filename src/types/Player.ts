...
export interface Player {
    ...
    levelUp(): void,
    weaponSlot: EquipmentSlot<Item>;
    armorSlots: EquipmentSlot<Item>[];
}
...
export function createPlayer(): Player {
    ...
    const weaponSlot = createEquipmentSlot<Item>(EquipmentSlotType.Weapon, {
        name: "Fists",
        description: "Your fists are your only weapon",
        id: "fists",
    });
    const armorSlots = [
        createEquipmentSlot<Item>(EquipmentSlotType.Head),
        createEquipmentSlot<Item>(EquipmentSlotType.Chest),
        createEquipmentSlot<Item>(EquipmentSlotType.Hands),
        createEquipmentSlot<Item>(EquipmentSlotType.Legs),
        createEquipmentSlot<Item>(EquipmentSlotType.Feet),
    ];
